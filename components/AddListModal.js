  ...
  render() {
    return (
      <KeyboardAvoidingView style={styles.container} behavior="padding">
        ...
        <TextInput style={styles.input} placeholder="Enter List Name" onChangeText={text => this.setState({name: text})} />
        ...
        <TouchableOpacity style={[styles.create,{backgroundColor: this.state.color}]} onPress={this.createTodo}>
          <Text style={{color: col.white, fontWeight:"600"}}> Create!</Text>
        </TouchableOpacity>
        </View>
